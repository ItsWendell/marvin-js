        ...
        <div className="container">
          <div className="text-center">
            ...
            <p className="lead mt-3 mb-1">
              ...
              <span className="font-weight-bold">{this.props.session.user.email}</span>.
            </p>
          </div>
          <div className="row">
              ...
              <div className="card-body pb-0">
                ...
                >
                  ...
                  <p className="text-right">
                    <button id="submitButton" type="submit" className="btn btn-outline-primary">
                      Sign in with email
                    </button>
                  </p>
                </form>
...
export class LinkAccounts extends React.PureComponent {
  render() {
    return (
      <div className="card mt-3 mb-3">
...
export class LinkAccount extends React.PureComponent {
  render() {
...
export class SignInButtons extends React.PureComponent {
  render() {
    return (
      <React.Fragment>
